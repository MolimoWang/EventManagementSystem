...
![Do not Disable](/02-analysis/sequence-diagrams/Administrator/14-disable_account- Do not Disable.png)
...
### Sequence Diagram-- Alternate Course of Events
![Account already disabled](/02-analysis/sequence-diagrams/Administrator/14-disable_account- Account already Disabled.png)
## UI Sketches
