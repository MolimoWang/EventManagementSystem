...
- The administrator selects an account from one of the lists displaying all accounts of that type and chooses to delete it.
- The system asks the administrator to confirm.
- The administrator selects **Yes**.
- The system update the view all accounts page with this account deleted.(07-view_all_accounts_administrators.png)(07-view_all_accounts_customers.png)(07-view_all_accounts_organisers.png)
