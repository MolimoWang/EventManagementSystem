...
public class RestaurantService {
    ...
    public void addReservation(String customerName, String customerPhoneNumber, LocalDate date, LocalTime time, DinnerTable table, int covers, boolean overfill) {
        Customer customer = getCustomer(customerName, customerPhoneNumber);
