...
|TM3| TM3, TM7 and TM8 complete the use cases involved in the front-end and back-end of the whole event management and ticket management, including the implementation of mybatis-plus in the framework, and the reform of the event ticket table structure, and the completion of the add, delete, change and view functions of the event ticket. It improves the function of associating tickets and types for venues, and completes the query of the day's event list according to the date                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|TM4| TM4, TM5 and TM6 worked together to complete the front-end and back-end of venue management including create venue, list venues, list my venue, edit venue and delete venue, the initialization of the event front-end, back-end and front end of ticket available, and debug for event management                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|TM5| TM4, TM5 and TM6 worked together to complete the front-end and back-end of venue management including create venue, list venues, list my venue, edit venue and delete venue, the initialization of the event front-end, back-end and front end of ticket available, and debug for event management                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|TM6| TM4, TM5 and TM6 worked together to complete the front-end and back-end of venue management including create venue, list venues, list my venue, edit venue and delete venue, the initialization of the event front-end, back-end and front end of ticket available, and debug for event management                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|TM7| TM3, TM7 and TM8 complete the use cases involved in the front-end and back-end of the whole event management and ticket management, including the implementation of mybatis-plus in the framework, and the reform of the event ticket table structure, and the completion of the add, delete, change and view functions of the event ticket. It improves the function of associating tickets and types for venues, and completes the query of the day's event list according to the date                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|TM8| TM3, TM7 and TM8 complete the use cases involved in the front-end and back-end of the whole event management and ticket management, including the implementation of mybatis-plus in the framework, and the reform of the event ticket table structure, and the completion of the add, delete, change and view functions of the event ticket. It improves the function of associating tickets and types for venues, and completes the query of the day's event list according to the date                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
