...
|TM4| TM4, TM5 and TM6 worked together to complete the use cases involved in the front-end and back-end of the whole venue management including create venue, list venues, list my venue, edit venue and delete venue, the initialization of the front-end of the whole event management, also the back-end and the front end of the whole ticket available part including ticket types and available number, improving the function of associating venue and event, and , and debug for event and venue management.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|TM5| TM4, TM5 and TM6 worked together to complete the use cases involved in the front-end and back-end of the whole venue management including create venue, list venues, list my venue, edit venue and delete venue, the initialization of the front-end of the whole event management, also the back-end and the front end of the whole ticket available part including ticket types and available number, improving the function of associating venue and event, and , and debug for event and venue management.                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|TM6| TM4, TM5 and TM6 worked together to complete the use cases involved in the front-end and back-end of the whole venue management including create venue, list venues, list my venue, edit venue and delete venue, the initialization of the front-end of the whole event management, also the back-end and the front end of the whole ticket available part including ticket types and available number, improving the function of associating venue and event, and , and debug for event and venue management.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
