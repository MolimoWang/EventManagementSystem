...
## Description
- This use case allows an administrator to create a new administrator account in the system. The administrator can choose to create one of three types of accounts: User, Organizer, or Administrator.
## Actors
- Administrator

## Triggers
- The administrator decides to create a new administrator account in the system.
...
## Postconditions
- A new administrator account is created in the system.
