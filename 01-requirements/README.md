...
1. [View All Events](UseCase/AllObject/01-view_all_events.md)
2. [View Events History](UseCase/Administrator/view_events_history.md)
3. [Delete Event](UseCase/AllObject/02-delete_event.md)
4. [View All Venues](UseCase/AllObject/05-view_all_venues.md)
...
12. [Edit User Account](UseCase/AllObject/08-modify_account.md)
...
22. [View Event Details](UseCase/AllObject/03-view_event_details.md)
23. [View Event Registrations](UseCase/AllObject/04-view_event_registrations.md)
24. [Display Date](UseCase/AllObject/09-display_date.md)
...
28. [View Venue Details](UseCase/AllObject/06-view_venue_details.md)
29. [View Venue Bookings](UseCase/Organizer/view_venue_bookings.md)
30. [View Organizer Account](UseCase/AllObject/07-view_account.md)
...
33. [Display Date](UseCase/AllObject/33-display_date.md)
...
37. [View Event Details (User)](UseCase/AllObject/37-view_event_details_user.md)
38. [Search and Filter Events](UseCase/AllObject/10-search_filter_events.md)
39. [Purchase Ticket](UseCase/User/purchase_ticket.md)
40. [View Purchased Tickets](UseCase/User/ticket_lists.md)
...
| Use Case 18: "List Events"                  | ![List Events](UI/organizer/18-list_my_events.png)                                |
